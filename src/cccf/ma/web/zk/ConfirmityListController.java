...
public class ConfirmityListController extends GenericForwardComposer{
	...
	public ComponentInfo doBeforeCompose(Page page, Component parent,
		...
		tasklist=Functions.getCurrentLoginUserTaskList("符合性审查");
	...
	{
		tasklist=Functions.getCurrentLoginUserTaskList("符合性审查");
		confirmityLbx.setModel(new ListModelList(tasklist));
	}
