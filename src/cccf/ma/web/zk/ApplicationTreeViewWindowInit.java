...
public class ApplicationTreeViewWindowInit extends org.zkoss.zkplus.databind.AnnotateDataBinderInit {
public void doAfterCompose(Page page,org.zkoss.zk.ui.Component[] comps)throws Exception {
	
	
 	List list=ApplicationInfoServiceUtil.getApplicationListSubmit();
