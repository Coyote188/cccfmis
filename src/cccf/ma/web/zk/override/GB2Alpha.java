...
public class GB2Alpha {
	 ...
	 * 
	 * @param ascii Integer �ַ��Ӧ��ASCII
	 * @return String ƴ��,�����ж�ASCII�Ƿ�>0&<160,����Ƿ��ض�Ӧ���ַ�,����SpellMap�в���,���û���ҵ�ƴ��,�򷵻�null,����ҵ��򷵻�ƴ��.
	 */
	private static String getSpellByAscii(int ascii) {
		if (ascii > 0 && ascii < 160) { // ���ַ�--Ӣ�Ļ����ַ�
	...
	public static String getFullSpell(String cnStr) {
		...
		for (int i = 0, Len = chars.length; i < Len; i++) {
			int ascii = getCnAscii(chars[i]);// �õ��������ĵ�ASCII��
			if (ascii == 0) { // ȡASCIIʱ����
