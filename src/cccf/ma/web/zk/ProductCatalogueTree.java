...
public class ProductCatalogueTree implements TreeModel{
	
	private List<ProductCatalogueInfo> root;
	/**
	 * 初始化根目录
	 */
	public ProductCatalogueTree()
	{
		root=ProductCatalogueTreeService.getDataListByLevelAll(1);
	...
	public Object getChild(Object parent, int index) {
		if(parent instanceof List)
		{
            return ((List)parent).get(index); 
                ...
                ProductCatalogueTreeService.getProductChildren((ProductCatalogueInfo)parent); 
	...
	public int getChildCount(Object parent) {
         ...
         else if(parent instanceof ProductCatalogueInfo)
         {
        	 ...
        	 return (int)ProductCatalogueTreeService.getProductChildrenCount((ProductCatalogueInfo)parent);  
         }
         else  
             return 0;   
	}
	...
	public boolean isLeaf(Object node) {
		return ProductCatalogueTreeService.checkIsLeaf((ProductCatalogueInfo)node); 
	}
