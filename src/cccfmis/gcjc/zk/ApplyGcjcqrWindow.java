 ...
 */
public class ApplyGcjcqrWindow extends GenericComposer {
	/**
	 * 
	 */
	...
	public ComponentInfo doBeforeCompose(org.zkoss.zk.ui.Page page, org.zkoss.zk.ui.Component parent, org.zkoss.zk.ui.metainfo.ComponentInfo compInfo) {
		...
		try {
			JEntityAdapter adapter = JAdapterFactry.createJEntityAdapterByTable(source, "fig_batch", "state='待审核'");
	...
	public void onPass() throws SQLException {
		...
		map.put("state", "待确认");
		adapter.commit(map);
		JEntityAdapter adapter1 = JAdapterFactry.createJEntityAdapterByTable(source, "fig_batch", "state='待审核'");
