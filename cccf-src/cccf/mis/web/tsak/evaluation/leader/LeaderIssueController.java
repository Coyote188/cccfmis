package cccf.mis.web.tsak.evaluation.leader;
...
public class LeaderIssueController
		extends GenericForwardComposer
{
	...
	TechnicalEvaluationApprovalService svc = BeanAdapter.getBean("TechnicalEvaluationApprovalService", TechnicalEvaluationApprovalService.class);
...
String applyno = (String) selectItem.get("applyno");
			...
			throws InterruptedException
	{
		...
		{ 
			...
			String approveResult  = (String) resultListbox.getSelectedItem().getValue(); 
			
			svc.doEvaluationApproval(report, usid, approveResult,  approveMemo.getText()); 
